...
class App:
	def __init__(self,video_source = 0):
		...
		self.appname="Live Video Surveillance"
		self.window=Tk()
		...
		image1=Image.open("bgImages/bg3.jpg")
		image1 = image1.resize((1250,800), Image.ANTIALIAS)
	...
	def update(self):
		...
		if isTrue:
			...
			for(top,right,bottom,left),name in zip(self.face_locations,self.face_names):
				...
				#cv2.putText(self.frame,name,(left+6,bottom-6),font,1.0,(225,225,225),1)
